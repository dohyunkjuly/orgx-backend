...
CREATE TABLE `user_email_verification_tokens` (
    ...
    UNIQUE INDEX `user_email_verification_tokens_tokenHash_key`(`tokenHash`),
    INDEX `user_email_verification_tokens_userId_idx`(`userId`),
    INDEX `user_email_verification_tokens_expiresAt_idx`(`expiresAt`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `user_password_reset_tokens` (
    ...
    UNIQUE INDEX `user_password_reset_tokens_tokenHash_key`(`tokenHash`),
    INDEX `user_password_reset_tokens_userId_idx`(`userId`),
    INDEX `user_password_reset_tokens_expiresAt_idx`(`expiresAt`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
