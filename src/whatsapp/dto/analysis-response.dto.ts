...
export class WhatsAppAnalysisResponseDto {
  ...
  @ApiProperty({
    ...
    description:
      'Computed analytics: summary, participants, mostActive/leastActive, frequency, peakHours, messageTypes, sentiment, spam, influence, interactions, emotional.',
  })
